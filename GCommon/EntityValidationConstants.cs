...
public static class EntityValidationConstants
    ...
    public static class PlannedRepair
        {
        public static readonly string[] ShunterPR = { "Tp1", "Tp2", "Tp1", "Tp2", "Tp1", "Mpr" };
        public static readonly string[] MainlinePR = { "Tp1", "Tp1", "Tp1", "Mpr" };
        }
    public static class AuditLog
        ...
        public const int EntityNameMinLength = 3;
